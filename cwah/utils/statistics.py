...
'''old dataset'''
#parser.add_argument("--dataset_path", default='/work/watch_and_help/dataset/test_env_set_help_filtered.pik', type=str)
...
parser.add_argument('--test_task', default=(0, 5, 10, 16, 20, 26, 30, 32, 40, 49), type=int, nargs='+',
					help='task ids to be tested')
parser.add_argument("--dataset_path", default='/workwatch_and_help/dataset/test_env_set_help.pik', type=str)
...
parser.add_argument("--single_dir", default='/work/test_results/vision4.3/single_vision__normal_image_2', type=str) # visual
