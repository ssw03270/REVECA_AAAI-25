...
def create_video(video_folder, format, out_file):
    ...
    frame_rate = 2
    midname = 'demowww.mp4'
    subprocess.call(['/work/watch_and_help/ffmpeg-6.0-amd64-static/ffmpeg',
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dir", default='/work/test_results/vision_ML_chatgpt_cot_record_2/image/Bob', type=str)
